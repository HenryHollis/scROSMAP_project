...
cyclops_fit= "/Users/henryhollis/Box Sync/Henry_stuff/AD_project/human_data/Cyclops_folders/training_output/scROSMAP/cogdx_controls/wAD/ExcitatoryNeurons/TMMs_w_batch/Exc3and5_FiltByEdgeRDefault_fixedipBulkChenZhang_condAndBatchCovs_04ContrVar4EGdefault_noTransferFit/Fits/Fit_Output_2024-01-18T10_45_00.csv"

#I want to arrange the heatmaps by acrophase so I need this
#CTL_cycling_file = "training_output/scROSMAP/cogdx_controls/wAD/ExcitatoryNeurons/TMMs_w_batch/Exc3and5_FiltByEdgeRDefault_fixedipBulkChenZhang_condAndBatchCovs_04ContrVar4EGdefault_noTransferFit/downstream_output_Exc3_5/cosinor_results_CTL.csv"
CTL_cycling_file = "/Users/henryhollis/Box Sync/Henry_stuff/AD_project/human_data/Cyclops_folders/training_output/scROSMAP/cogdx_controls/wAD/ExcitatoryNeurons/TMMs_w_batch/Exc3and5_FiltByEdgeRDefault_fixedipBulkChenZhang_condAndBatchCovs_04ContrVar4EGdefault_noTransferFit/downstream_output_Mglia_4_5_6_7_8_10_11_13_15_16/cosinor_results_CTL.csv"

#path to normalized counts
path_to_tmm_file = "/Users/henryhollis/Box Sync/Henry_stuff/AD_project/human_data/Cyclops_folders/tmms/scROSMAP/cogdx_controls/EdgeR_filt_normed/Microglia_4_5_6_7_8_10_11_13_15_16_FiltByExprDefault_TMM_CombatAdjusted.csv"
...
```{r}
setwd("~/Box Sync/Henry_stuff/AD_project/scROSMAP/Rscripts/automatic_downstream_analysis/MsigDB_gmts_for_GSEA/")
...
```{r}
library(gplots)
heatmap.2(as.matrix(heatmap_data), col = cm.colors, tracecol = "black", trace = "none", dendrogram = "none", scale ="row", Rowv = NA, Colv = NA, labCol = as.character(seq(0, 24, by = 6)), main = paste("KEGG Ribosome Pathway", plot_title))
```
...
```{r}
heatmap.2(as.matrix(heatmap_data_oxphos), col = cm.colors, tracecol = "black", trace = "none", dendrogram = "none", scale ="row", Rowv = NA, Colv = NA, labCol = as.character(seq(0, 24, by = 6)), main = paste("KEGG OxPhos Pathway", plot_title))
```
