...
```{r}
dir = "../edgeR_diff_expression/Ast_1_2_5_6_7_8/"
# dir = "../edgeR_diff_expression/Exc3_5/"
# dir = "../edgeR_diff_expression/Inhib_2_8_11_12_13/"
# dir = "../edgeR_diff_expression/Mglia_4_5_6_7_8_10_11_13_15_16/"
```
...
background = select(edgeR_de_qlftest, Gene_Symbols)
...
if (!(dir.exists("fGSEA"))){
  dir.create("fGSEA")
  dir.create(paste("fGSEA", "rnk_files", sep = "/"))
  dir.create(paste("fGSEA", "fGSEA_results", sep = "/"))
}
...
edgeR_de_qlftest_minusLogPRanked =  mutate(edgeR_de_qlftest, metric = -log(PValue)) %>% arrange(PValue) %>% select(Gene_Symbols, metric)
