...
path_to_tmm_file = "../normed_counts/InhNeurons_2_8_11_12_13_FiltByExprDefault_TMM.csv"

# optional path to file containing differential expression results
edgeR_de_filename = "../edgeR_diff_expression/Inhib_2_8_11_12_13/Inhib_2_8_11_12_13_filtByExpr_combatSeq_edgeR_DE_exactTest.csv"
...
#AD severity
system(paste0("python3 ", path_no_space, "/downstream_helpers/Python_EnrichR_for_AnalysisPipeline.py -g \"enrichR_files/strong_cogdx_diffs_AR25.csv\" -b \"enrichR_files/AD_cyclers_AR25BHQ05.csv\""))
```
...
order_prot( tmt_filename, path_to_cyclops_ordering)
```
