...
eneuron_CTL = read_csv("../Cyclops_ordering/downstream_output_Exc3_5/cosinor_results_CTL.csv", show_col_types = F) %>%  filter(as.numeric(amp_ratio) >=amplitudeRatioCutoff & as.numeric(BHQ) < isCyclingSigCutoff) %>% arrange(as.numeric(BHQ))

Ineuron_CTL = read_csv("../Cyclops_ordering/downstream_output_Inh_2_8_11_12_13/cosinor_results_CTL.csv", show_col_types = F)%>%  filter(as.numeric(amp_ratio) >=amplitudeRatioCutoff & as.numeric(BHQ) < isCyclingSigCutoff) %>% arrange(as.numeric(BHQ))
