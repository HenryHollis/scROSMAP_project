...
diff_cycling_BHQ = filter(diff_cycling, BHQ < 0.3)
```
...
write.table(diff_cycling_out, "../Cyclops_ordering/metabolon/MetaboAnalyst/Diff_cycling_BHQ3.csv", sep = ',', row.names = F)
```
