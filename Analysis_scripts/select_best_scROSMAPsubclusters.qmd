...
cts = get_subluster_data("Exc\\.5$|Exc\\.3$")
...
ggplot(as.data.frame(pc_res$x), aes(x = PC1, y = PC2, color = colorvec))+geom_point()#+scale_color_gradient(low = "blue", high = "red")
ggplot(as.data.frame(pc_res$x), aes(x = PC2, y = PC3, color = colorvec))+geom_point()#+scale_color_gradient(low = "blue", high = "red")
ggplot(as.data.frame(pc_res$x), aes(x = PC1, y = PC3, color = colorvec))+geom_point()#+scale_color_gradient(low = "blue", high = "red")
```
