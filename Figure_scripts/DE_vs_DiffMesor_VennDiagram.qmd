...
```{r}
make_venn = function(diff_mesor_file, path_to_DE, my_title, signif_cutoff = 0.05, save_plots = T){
...
EN_DE_path = "../edgeR_diff_expression/All_Exc/All_Exc_filtByExpr_edgeR_DE_QLFTest.csv"
...
EN_not_DE_3_5 = make_venn(EN_mesor_path_3_5, EN_DE_path_3_5, "Exc. Neurons 3,5")
EN_not_DE = make_venn(EN_mesor_path, EN_DE_path, "Exc. Neurons")
